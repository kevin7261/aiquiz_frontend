/**
 * 建立「英文測驗題庫」專用：Pack 虛擬資料夾 Composable（與 `usePackTasks.js` 分離）
 *
...
export function useEnglishExamPackTasks(currentState, fileMetadataToShow, packAndGenerateDisabled) {
