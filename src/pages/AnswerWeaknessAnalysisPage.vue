        ...
        <div v-if="weaknessReport" class="my-callout-primary-soft rounded-3 text-start my-page-block-spacing p-3 p-lg-4">
          ...
          <template v-if="weaknessReportParsed">
            <div
              ...
              class="mb-3"
            >
              <div class="my-font-sm-600 my-color-gray-1 mb-2">{{ sectionKey }}</div>
              ...
              <div v-else-if="Array.isArray(weaknessReportParsed[sectionKey]) && weaknessReportParsed[sectionKey].length === 0" class="my-font-sm-400 my-color-gray-4">—</div>
